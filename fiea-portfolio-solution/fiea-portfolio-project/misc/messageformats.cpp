...
namespace AWE {
    ...
    std::string MessageFormats::success() const { return _success; }
    std::string MessageFormats::failure() const { return _failure; }
    std::string MessageFormats::other() const { return _other; }
